...
/* Title:            Zelda Puzzle Solved
 * Author/Composer:  Koji Kondo
 * License:          Public Domain
 */
#define ZELDA_PUZZLE Q__NOTE(_A4), Q__NOTE(_B4), Q__NOTE(_C5), Q__NOTE(_D5), Q__NOTE(_E5), Q__NOTE(_F5), Q__NOTE(_G5), Q__NOTE(_A5)
